    ...
    render() {
        const title = <div className="row form-group">
                        ...
                        <div className="col-12 col-md-9">
                            <input onChange={this.handler_title} type="text" id="text-input" name="text-input" placeholder="Title" className="form-control" />
        ...
        const descript =  <div className="row form-group">
                            ...
                            <div className="col-12 col-md-9">
                                <textarea onChange={this.handler_descript} name="textarea-input" id="textarea-input" rows={9} placeholder="Content..." className="form-control" defaultValue={""} />
                            </div>
                        </div>
        const cpu = <div className="row form-group">
                        ...
                        <div className="col-12 col-md-9">
                            <input onChange={this.handler_cpu} className="form-control" />
        ...
        const display = <div className="row form-group">
                        ...
                        <div className="col-12 col-md-9">
                            <input onChange={this.handler_display} type="text" id="disabled-input" name="disabled-input" placeholder="Display" className="form-control" />
                        </div>
                    </div>
        const gpu = <div className="row form-group">
                        ...
                        <div className="col-12 col-md-9">
                            <input onChange={this.handler_gpu} type="text" id="disabled-input" name="disabled-input" placeholder="GPU" className="form-control" />
                        </div>
                    </div>
        const disk = <div className="row form-group">
                        ...
                        <div className="col-12 col-md-9">
                            <input onChange={this.handler_disk} type="text" id="disabled-input" name="disabled-input" placeholder="Disk" className="form-control" />
                        </div>
                 </div>
        ...
        const color = <div className="card-body card-block">
                        <div className="row form-group">
                            ...
                            <div className="col-12 col-md-9">
                                <select onChange={this.handler_color} name="select" id="select" className="form-control">
